...
When rheo generates html, it injects a #link(rheo-source-url + "/blob/main/src/css/style.css")[default stylesheet] into the generated HTML files for a simple, modern, and mobile-friendly aesthetic. 
...
Note that if your project contains this file, _none_ of the styles in the default stylesheet will be applied.
