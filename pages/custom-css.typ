...
Rheo generates HTML, it injects a #link(rheo-source-url + "/blob/main/src/css/style.css")[default stylesheet] into the generated static site for a simple, modern, and mobile-friendly aesthetic. 
